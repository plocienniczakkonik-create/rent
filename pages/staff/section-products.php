...
<div class="card">
    <div class="card-header d-flex align-items-center justify-content-between">
        ...
        <a class="btn btn-sm btn-primary" href="pages/product-form.php">Dodaj produkt</a>
    </div>
                    ...
                    <?php if (!$products): ?>
                        ...
                        <?php else: foreach ($products as $p): ?>
                            <tr>
                                ...
                                <td class="text-end">
                                    <a href="pages/product-form.php?id=<?= (int)$p['id'] ?>" class="btn btn-outline-primary btn-sm">Edytuj</a>
                                    <a href="pages/product-delete.php?id=<?= (int)$p['id'] ?>&csrf=<?= htmlspecialchars(csrf_token()) ?>"
