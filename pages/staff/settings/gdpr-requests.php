...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'], $_POST['request_id'])) {
    ...
    $action = $_POST['action'];
    $req = $db->prepare('SELECT * FROM gdpr_requests WHERE id = ?')->execute([$request_id]);
    ...
    if ($user_id) {
        if ($action === 'export') {
            ...
            echo '<div class="alert alert-success">Dane użytkownika zostały zanonimizowane/usunięte.</div>';
        }
    }
}
