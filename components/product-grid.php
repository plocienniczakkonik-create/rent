        ...
        <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <?php else: ?>
                            ...
                            <div class="col-12 col-md-6 col-lg-4">
                                <div class="card h-100 product-card-modern shadow-sm border-0 overflow-hidden">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <h5 class="card-title product-title-modern mb-3">
                    ...
                    <?php if ($pages > 1): ?>
                        <?php
                        // Funkcja do budowania URL paginacji z zachowaniem parametrów
                        ...
                        <nav class="mt-5">
                            <ul class="pagination-custom justify-content-center d-flex gap-2">
                                <li class="page-item-custom<?= $page <= 1 ? ' disabled' : '' ?>">
                                    ...
                                    <?php else: ?>
                                        <a class="page-link-custom" href="<?= buildPaginationUrl($page - 1) ?>">
                                            <i class="bi bi-chevron-left"></i>
                                            <span class="d-none d-sm-inline ms-1">Poprzednia</span>
                                        </a>
                                    <?php endif; ?>
                                ...
                                if ($start > 1): ?>
                                    <li class="page-item-custom">
                                        <a class="page-link-custom" href="<?= buildPaginationUrl(1) ?>">1</a>
                                    </li>
                                    <?php if ($start > 2): ?>
                                ...
                                <?php for ($i = $start; $i <= $end; $i++): ?>
                                    <li class="page-item-custom<?= $i === $page ? ' active' : '' ?>">
                                        <a class="page-link-custom" href="<?= buildPaginationUrl($i) ?>"><?= $i ?></a>
                                    </li>
                                <?php endfor; ?>
                                ...
                                <?php if ($end < $pages): ?>
                                    ...
                                    <?php endif; ?>
                                    <li class="page-item-custom">
                                        <a class="page-link-custom" href="<?= buildPaginationUrl($pages) ?>"><?= $pages ?></a>
                                    </li>
                                <?php endif; ?>
